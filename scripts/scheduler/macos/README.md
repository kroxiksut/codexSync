...
> removed in a later release. They keep their own settings in `launchd.config.sh`,
...
> If you installed a task with `install-launchd.sh`, remove it with the matching
